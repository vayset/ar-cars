...
const css=await readFile('source/experience/experience.css');
const cssName='experience-'+createHash('sha256').update(css).digest('hex').slice(0,12)+'.css';
await writeFile('docs/experience/'+cssName,css);
const html=(await readFile('source/experience/index.html','utf8')).replace('src="./experience.js"','src="./'+name+'"').replace('href="./experience.css"','href="./'+cssName+'"');
